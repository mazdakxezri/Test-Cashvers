<aside class="sidebar-space">
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('bitlabs.index') }}" class="sidebar-link {{ request()->routeIs('bitlabs.index') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('achievements.index') }}" class="sidebar-link {{ request()->routeIs('achievements.index') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('tiers.index') }}" class="sidebar-link {{ request()->routeIs('tiers.index') ? 'active' : '' }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                <path d="M12 2v15.77"></path>
            </svg>
