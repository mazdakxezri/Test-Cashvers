...
@section('title', 'New Custom Offer')
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row row-cards">
                <div class="card px-0">
                    <div class="col-12">
                        <form method="POST" action="{{ route('admin.offers.custom.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-lg-6 col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="custom_offer_name"
                                            placeholder="Enter custom offer name" value="{{ old('custom_offer_name') }}"
                                            required />
                                    ...
                                    <div class="col col-lg-6 col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <select name="country[]" class="form-select" id="select-countries" multiple
                                            ...
                                            @foreach ($countries as $code => $name)
                                                <option value="{{ $code }}"
                                                    {{ in_array($code, old('country', [])) ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col col-lg-6 col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="custom_offer_payout"
                                            ...
                                            value="{{ old('custom_offer_payout') }}" required />
                                    ...
                                    <div class="col col-lg-6 col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="offer_id"
                                            placeholder="Enter offer ID" value="{{ old('offer_id') }}" required />
                                        @error('offer_id')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col col-lg-6 col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="offer_requirement" data-bs-toggle="autosize"
                                            ...
                                            style="overflow: hidden; overflow-wrap: break-word; resize: none; text-align: start; height: 100px;">{{ old('custom_offer_description') }}</textarea>
                                    ...
                                    <div class="col col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <select class="form-select" name="offer_device" required>
                                            <option value="all" {{ old('offer_device') == 'all' ? 'selected' : '' }}>All
                                            </option>
                                            <option value="android"
                                                {{ old('offer_device') == 'android' ? 'selected' : '' }}>Android</option>
                                            <option value="ios" {{ old('offer_device') == 'ios' ? 'selected' : '' }}>iOS
                                            </option>
                                            <option value="desktop"
                                                {{ old('offer_device') == 'desktop' ? 'selected' : '' }}>Desktop</option>
                                        </select>
                                        @error('offer_device')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <input type="url" class="form-control" name="custom_offer_link"
                                            placeholder="Enter offer Link" value="{{ old('custom_offer_link') }}"
                                            required />
                                ...
                                <div class="card-footer text-end">
                                    <button type="submit" class="btn btn-primary">Add Custom Offer</button>
                                </div>
                            </div>
                        </form>
                    </div>
