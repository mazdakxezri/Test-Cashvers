                    ...
                    <form action="{{ route('admin.events.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name') }}" required placeholder="Weekend 2x Earnings!">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="2" required placeholder="Earn double rewards on all offers this weekend!">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('event_type') is-invalid @enderror" 
                                    ...
                                    <option value="bonus_multiplier" {{ old('event_type') == 'bonus_multiplier' ? 'selected' : '' }}>Bonus Multiplier</option>
                                    <option value="special_offers" {{ old('event_type') == 'special_offers' ? 'selected' : '' }}>Special Offers</option>
                                    <option value="contest" {{ old('event_type') == 'contest' ? 'selected' : '' }}>Contest</option>
                                    <option value="announcement" {{ old('event_type') == 'announcement' ? 'selected' : '' }}>Announcement</option>
                                </select>
                                @error('event_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="color" class="form-control form-control-color @error('banner_color') is-invalid @enderror" 
                                       id="banner_color" name="banner_color" value="{{ old('banner_color', '#00B8D4') }}" required>
                                @error('banner_color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('bonus_multiplier') is-invalid @enderror" 
                                       id="bonus_multiplier" name="bonus_multiplier" value="{{ old('bonus_multiplier', 2.00) }}" min="1" max="10">
                                <small class="text-muted">e.g., 2.00 for 2x earnings</small>
